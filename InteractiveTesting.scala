object InteractiveTesting {
  ...
  val libpath = "/home/vr/code/autoquiz/target/scala-2.12/autoquiz_v0.0.3-SNAPSHOT.jar"
  ...
  def writeAllQA: (Option[File], List[File], List[(File, String)]) = {
    ...
    secFileGroupTrios.toNel match {
      ...
      case Some(trios) => {
        ...
        val preamble = standardPreamble("All Questions", "Vince Reuter", "February 17, 2020")
